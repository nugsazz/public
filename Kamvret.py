    ...
    try:
        ...
        if op.type == 19:
           if op.param2 not in admin:
                _name = cl.getContact(op.param2).displayName
                G = cl.getGroup(op.param1)
                ginfo = cl.getGroup(op.param1)
                G.preventJoinByTicket = False
                cl.updateGroup(G)
                ...
                if targets ==[]:
                    ...
                    for target in targets:
                        try:
                            nl.kickoutFromGroup(op.param1,[target])
                            nl1.kickoutFromGroup(op.param1,[target])
						...
						if targets == []:
							...
							for target in targets:
									try:
										...
										ki.sendText(msg.to,"Succes Vanny")
										kk.sendText(msg.to,"Fuck You"),
...
#-------------------------------------------------------------                          
                      ...
                      cl.sendText(msg.to, ".................Sabar...Dikit...Napa...")
                      try:
                       del wait2['readPoint'][msg.to]
                       del wait2['readMember'][msg.to]
                      except:
		   ...
		   cl.sendText(msg.to, "Oi Blom Di Ketik Koplak\n\nDASAR PIKUN ♪")  
#-------------------------------------------------------------                                               
