...
admin=["u8f85b39935a169005065036c9bfe4170"]
admin=["ua4872a5a9a3b3be7cb07668b486c0e19"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#------Yang kick member langsung terkick-------
     ...
     for zx in range(0,100):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Syams\n\nyoutube.com/c/SYAMSPlayMC")
            kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Syams\n\nyoutube.com/c/SYAMSPlayMC")
            print "Like"
          except:
            pass
        else:
