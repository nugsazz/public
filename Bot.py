...
ki.login(token="EmRqC7LBsQitS0VyVOE3.sHL9kYER5ijeTd6uWLWZyW.WffV9l173omE15Vp+V7G1Ne5gw/dKXwdu90NSwunTC0=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="Emk4EV0WfDcmiM9pjTZ4.T8cBKunQVRWPfQbaUQ0FHa.UseGFaKx9LG1V6O+8szT6EZfi3YNBye9ox1E2B86f8Y=")
kk.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 15:
            ...
            print "Ada Orang Yang Keluar Dari Group Good By Kaka Jangan Kembali Lagi"
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					kk.sendText(msg.to,"Vanny Selalu Hadir Demi Kakak Tersayang")
#-----------------------------------------------
...
#----------------------------------------------------------
 ...
 #-------------Fungsi Spam Start---------------------#
            	...
            	if msg.from_ in admin:
                  ...
                  ki.sendText(msg.to,"Bdjndbdjfjdbfhdjbridbdbdbdhbdbd!􏿿")
                  ...
                  cl.sendText(msg.to,"Hdhdbdbbdbdbf!􏿿")
                  ...
                  ki.sendText(msg.to,"Capek Aha Nulisnya!􏿿")
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      pass
#-----------------------------------------------
            elif "AkuJombloSelamanya?" in msg.text:
                tanya = msg.text.replace("AkuJombloSelamanya?","")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					kk.sendText(msg.to,"Vanny Selalu Ada Untuk Kakak")
#----------------------------------------------
